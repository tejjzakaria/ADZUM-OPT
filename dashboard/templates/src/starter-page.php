...
<head>
    <meta charset="utf-8" />
    <title>Starter Page | Adzum</title>
        ...
        <div class="sidenav-menu">
            ...
            <a href="index.php" class="logo">
                <span class="logo-light">
                    <span class="logo-lg"><img src="../assets/images/logo.png" alt="logo" width="60%" style="height: auto;"></span>
                    <span class="logo-sm text-center"><img src="../assets/images/logo-sm.png" alt="small logo" style="height: auto;"></span>
                </span>

                <span class="logo-dark">
                    <span class="logo-lg"><img src="../assets/images/logo-dark.png" alt="dark logo" style="height: auto;"></span>
                    <span class="logo-sm text-center"><img src="../assets/images/logo-sm.png" alt="small logo" style="height: auto;"></span>
                </span>
            </a>
                    ...
                    <div class="col-12">
                        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 text-uppercase fw-bold m-0">Starter Page</h4>
                            </div>
